  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F8FAFC', fontFamily: 'Inter, system-ui, sans-serif', paddingBottom: 88 }}>
      <div className="flex items-center gap-3 px-4 py-4 bg-white border-b border-[#E2E8F0]">
        ...
        <h1 className="text-base font-bold text-[#0B1E3D]">{t('title')}</h1>
      </div>
      ...
      <div className="px-5 py-6">
        <div className="bg-white rounded-2xl border border-[#E2E8F0] p-5">
          <div className="flex items-center justify-between gap-4">
            <div>
              <p className="text-sm font-semibold text-[#0B1E3D]">{t('password')}</p>
              <p className="text-xs text-[#5A6A7A] mt-0.5">{t('password_desc')}</p>
            </div>
            <button
