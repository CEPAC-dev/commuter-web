...
export default function TripChat({ tripInstanceId, role, currentUserId }: TripChatProps) {
  ...
  const btnLabel = role === 'user' ? t('chat_with_driver') : t('chat_with_passenger');
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div>
                <p style={{ margin: 0, fontSize: 15, fontWeight: 800, color: '#0B1E3D' }}>{btnLabel}</p>
          ...
          >
            {loadError && (
              <p style={{ textAlign: 'center', color: '#E74C3C', fontSize: 13 }}>{loadError}</p>
            )}
              ...
              return (
                ...
                >
                  {!isSelf && msg.sender?.name && (
                    <span style={{ fontSize: 10, color: '#9AA0A6', marginBottom: 2, paddingInlineStart: 4 }}>
                      {msg.sender.name}
                    </span>
                  )}
                  <div style={{
                  ...
                  <span style={{ fontSize: 10, color: '#B0B8C1', marginTop: 3, paddingInlineStart: 4 }}>
